const CACHE_NAME = "stardew-wasm-v3";
const ASSETS_TO_CACHE = [
	...
	"./_framework/dotnet.native.rdr2oxwy28.js",
	"./_framework/dotnet.runtime.2hocyfcbj2.js",
	"./_framework/blazor.boot.json",
	"./_framework/dotnet.native.4besgko34q.wasm.count",
	"./_framework/dotnet.native.4besgko34q.wasm0",
	"./_framework/dotnet.native.4besgko34q.wasm1",
	"./_framework/dotnet.native.4besgko34q.wasm2",
	"./_framework/FNA.19mbt6y4zi.wasm",
	"./_framework/mscorlib.emnk2ck1oc.wasm",
	"./_framework/stardew.oo74tgnf8n.wasm",
